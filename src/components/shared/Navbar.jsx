        ...
        <div className="flex items-center gap-2 shrink-0">
          <div className="flex items-center p-1 bg-white/95 border border-amber-900/20 rounded-2xl shadow-sm">
            <button
              type="button"
              onClick={() => setLang('ta')}
              className={`min-h-[36px] sm:min-h-[38px] px-3 sm:px-3.5 py-1 rounded-xl text-xs font-serif font-bold transition-all active:scale-95 touch-target flex items-center justify-center ${lang === 'ta'
            ...
            <button
              type="button"
              onClick={() => setLang('en')}
              className={`min-h-[36px] sm:min-h-[38px] px-3 sm:px-3.5 py-1 rounded-xl text-xs font-divine font-bold transition-all active:scale-95 touch-target flex items-center justify-center ${lang === 'en'
                  ? 'bg-gradient-to-r from-amber-600 to-amber-500 text-white shadow-sm'
                  : 'text-amber-900 hover:text-amber-700'
                }`}
