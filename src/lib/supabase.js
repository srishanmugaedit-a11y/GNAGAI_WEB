...
export function saveSupabaseCredentials(url, key) {
    if (typeof window !== 'undefined') {
        localStorage.setItem('gangai_supabase_url', url.trim());
        localStorage.setItem('gangai_supabase_key', key.trim());
        supabaseInstance = null; // reset client
    }
}
export function clearSupabaseCredentials() {
    if (typeof window !== 'undefined') {
        localStorage.removeItem('gangai_supabase_url');
        localStorage.removeItem('gangai_supabase_key');
